        ...
        if(key.obName.equals(taxi.name())){
            if(key.obVarKey.equals(VAR_OCCUPIEDTAXI)){
                ...
                if(value instanceof String){
                	...
                	throw new RuntimeException("Variable value must be String for key VAR_CURRENTLOCATION "
                			+ "in TaxiState for the Taxi agent: " + value.toString());
            }
            else{
        ...
        if(indL!=-1){
            if(key.obVarKey.equals(VAR_LOCATION)){
                if(value instanceof String){
                	...
                	throw new RuntimeException("Variable value must be String for key VAR_LOCATION"
                			+ " in TaxiState for TaxiLocation: " + value.toString());
            }
            else{
        ...
        if(indP!=-1){
            if(key.obVarKey.equals(VAR_GOALLOCATION)){
                if(value instanceof String){
                	...
                	throw new RuntimeException("Variable value must be String for key VAR_GOALLOCATION"
                			+ " in TaxiState for TaxiPassenger: " + value.toString());
            }
                ...
                if(value instanceof String){
                	...
                	throw new RuntimeException("Variable value must be String for key VAR_CURRENTLOCATION"
                			+ " in TaxiState for the Taxi passenger: " + value.toString());
            }
            else{
