...
public class AgentDoorMapper implements StateMapping {
    ...
    public State mapState(State sIn) {
        ...
        MoveAgent abstractAgent = new MoveAgent(agent, inRegion);
        ...
        for(CleanupRoom r : rooms){
            MoveRoom rL1 = new MoveRoom(r, new HashSet<String>());
        ...
        for(CleanupDoor d : doors){
            MoveDoor ad = new MoveDoor(d, new HashSet<String>());
        ...
        for(CleanupBlock b : blocks){
            ...
            MoveBlock ab  = new MoveBlock(b, blockInRegion);
