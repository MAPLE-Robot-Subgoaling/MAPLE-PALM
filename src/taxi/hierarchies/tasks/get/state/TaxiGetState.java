...
public class TaxiGetState implements MutableOOState {
	...
	public TaxiGetState(List<TaxiGetPassenger> pass, List<TaxiGetLocation> loc) {
		...
		for(TaxiGetLocation l : loc){
			this.locations.put(l.name(), l);
		}
	}
	
	private TaxiGetState(Map<String, TaxiGetPassenger> pass, Map<String, TaxiGetLocation> loc) {
	...
	public List<ObjectInstance> objectsOfClass(String oclass) {
		...
		else if(oclass.equals(TaxiGetDomain.CLASS_LOCATION))
	...
	public MutableOOState addObject(ObjectInstance o) {
		if(o instanceof TaxiGetPassenger || o.className().equals(TaxiGetDomain.CLASS_PASSENGER)){
	...
	public TaxiGetLocation touchLocation(String locName){
		TaxiGetLocation l = locations.get(locName).copy();
	...
	public String toString(){
		...
		for(TaxiGetLocation l : locations.values()){
			out += l.toString() + "\n";
		}
		return out;
	}
