...
public class TaxiStateFactory {
	...
	public static TaxiState createClassicState(int numPassengers){
		TaxiAgent taxi = new TaxiAgent(Taxi.CLASS_TAXI + 0, 0, 12);
		
		List<TaxiLocation> locations = new ArrayList<TaxiLocation>();
		locations.add(new TaxiLocation(Taxi.CLASS_LOCATION + 0, 0, 19, Taxi.COLOR_RED));
		locations.add(new TaxiLocation(Taxi.CLASS_LOCATION + 1, 0, 0, Taxi.COLOR_YELLOW));
		locations.add(new TaxiLocation(Taxi.CLASS_LOCATION + 2, 12, 0, Taxi.COLOR_BLUE));
		locations.add(new TaxiLocation(Taxi.CLASS_LOCATION + 3, 19, 19, Taxi.COLOR_GREEN));
...
//                goalLocationName = Taxi.CLASS_LOCATION+0;
		...
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 0, 0, 0, 20, false)); //vertical left
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 1, 0, 0, 20, true)); //horizontal bottom
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 2, 20, 0, 20, false)); //vertical right
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 3, 0, 20, 20, true)); //horizontal top
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 4, 5, 0, 10, false));
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 5, 15, 0, 10, false));
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 6, 10, 10, 10, false));
...
//		passenger.set(Taxi.ATT_JUST_PICKED_UP, true);
	...
	public static TaxiState createThreeDepots(int numPassengers) {
		...
		List<TaxiLocation> locations = new ArrayList<TaxiLocation>();
		locations.add(new TaxiLocation(Taxi.CLASS_LOCATION + 0, 0, 0, Taxi.COLOR_RED));
		locations.add(new TaxiLocation(Taxi.CLASS_LOCATION + 1, 0, 1, Taxi.COLOR_YELLOW));
		locations.add(new TaxiLocation(Taxi.CLASS_LOCATION + 2, 0, 2, Taxi.COLOR_BLUE));
		...
		List<TaxiWall> walls = new ArrayList<TaxiWall>();
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 0, 0, 0, 4, false));
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 1, 1, 0, 4, false));
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 2, 0, 0, 1, true));
		walls.add(new TaxiWall(Taxi.CLASS_WALL + 3, 0, 4, 1, true));
