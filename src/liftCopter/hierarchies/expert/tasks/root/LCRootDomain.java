package liftCopter.hierarchies.expert.tasks.root;
...
import liftCopter.hierarchies.expert.tasks.root.state.LCRootCargo;
...
public class LCRootDomain implements DomainGenerator {
    ...
    public OOSADomain generateDomain() {
        ...
        domain.addStateClass(CLASS_PASSENGER, LCRootCargo.class);
    ...
    public static void main(String[] args) {
        ...
        LCRootDomain taxiBuild = new LCRootDomain();
