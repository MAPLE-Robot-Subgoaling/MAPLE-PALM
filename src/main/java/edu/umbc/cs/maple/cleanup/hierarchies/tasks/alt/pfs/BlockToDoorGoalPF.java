...
public class BlockToDoorGoalPF extends PropositionalFunction {

    public BlockToDoorGoalPF(){
        super("BlockToDoorGoalPF", new String[]{});
    }

    public BlockToDoorGoalPF(String name, String[] parameterClasses) {
