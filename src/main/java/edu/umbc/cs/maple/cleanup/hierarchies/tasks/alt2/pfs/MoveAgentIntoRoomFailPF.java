...
public class MoveAgentIntoRoomFailPF extends PropositionalFunction {

    public MoveAgentIntoRoomFailPF(){
        super("", new String[]{});
        name = this.getClass().getSimpleName();
    }

    public MoveAgentIntoRoomFailPF(String name, String[] parameterClasses) {
    ...
    public static boolean isTrue(CleanupState state, String[] params) {
        ...
        return !agentInRoom && !agentInDoor;
    }
