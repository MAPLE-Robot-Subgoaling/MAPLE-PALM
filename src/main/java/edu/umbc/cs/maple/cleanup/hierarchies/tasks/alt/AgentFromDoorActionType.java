...
public class AgentFromDoorActionType extends ObjectParameterizedActionType {

    public AgentFromDoorActionType() {
    ...
    protected boolean applicableInState(State s, ObjectParameterizedAction objectParameterizedAction) {
        ...
        return !AgentFromDoorGoalPF.isTrue(state, params);
    }
