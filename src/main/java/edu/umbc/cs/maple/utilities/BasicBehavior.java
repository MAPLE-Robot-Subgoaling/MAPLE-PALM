...
public class BasicBehavior {
    ...
    public BasicBehavior(){
        ...
        hashingFactory = new BugfixHashableStateFactory(false);
...
//		env.addObservers(observer);
    ...
    public void valueIterationExample(String outputPath){
        ...
        PolicyUtils.rollout(p, initialState, domain.getModel()).write(outputPath + "normalvi");
    ...
    public void multistepValueIteration(String outputPath, double maxDelta, int maxIterations, DiscountProvider discountProvider){
...
//        planner.toggleReachabiltiyTerminalStatePruning(true);
        Policy p = planner.planFromState(initialState);
        PolicyUtils.rollout(p, initialState, domain.getModel()).write(outputPath + "msvi");
        simpleValueFunctionVis((ValueFunction)planner, p);
        manualValueFunctionVis((ValueFunction)planner, p);
...
//        example.BFSExample(outputPath);
        ...
        double gamma = 0.99;
        DiscountProvider constantGamma = new ConstantDiscountProvider(gamma);
        example.multistepValueIteration(outputPath, maxDelta, maxIterations, constantGamma);
