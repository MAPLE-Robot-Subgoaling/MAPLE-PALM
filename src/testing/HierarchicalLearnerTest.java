...
public class HierarchicalLearnerTest {
    ...
    public static void runRAMDPEpisodes(ExperimentConfig conf, Task root, State initial, OOSADomain groundDomain) {
    ...
    public static void runRMAXQEpsodes(ExperimentConfig conf, Task root, State initState, OOSADomain domain){
        HashableStateFactory hs = new SimpleHashableStateFactory(true);
